...
public abstract class Piece extends ImageView implements Serializable {
    ...
    /** Possible Positions. */
    private Position[][] possiblePositions = new Position[26][8];
    /** First move or not. */
     ...
     *            for shifting piece.
     */
    Piece(Image image, String name, int xPosition, int yPosition, int zLevel, Color team,
        ...
        setX(shift + xPosition * squareSize + zLevel * (BOARDSIZE * squareSize + boardBorder));
        setY(shift + yPosition * squareSize);
        this.name = name;
        this.position = new Position(xPosition, yPosition, zLevel);
        this.team = team;
        resetTeam();
        this.live = true;
    ...
    */
    ...
    public void setPosition(Position position) {
        ...
        firstMove = false;
        super.setX(shift + position.getxPosition() * squareSize + position.getzLevel() * (BOARDSIZE * squareSize + boardBorder) );
    ...
    /**
     * Resets all possible positions.
     */
    public void resetPossiblePositions() {
        this.possiblePositions = new Position[26][8];
    }
